                    ...
                    while($rows=mysqli_fetch_assoc($result))
                    {
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <th style="width: 20%;text-align: end;"><p><form method="POST" action="php/likeartikel.php?id='.$rows['id'].'"><input type="image" src="photo/like.jpeg" style="width: 12%; height:12%" alt="">'.$rows['jml_like'].'</p></form></th>
                                <th style="width: 20%;"><p><form method="POST" action="php/dislikeartikel.php?id='.$rows['id'].'"><input type="image" src="photo/dislike.jpeg" style="width: 12%; height:12%" alt="">'.$rows['jml_dislike'].'</p></form><th>
                            </tr>
                            <tr>
